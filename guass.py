...
class GaussianBlur(nn.Module):
    ...
    def forward(self, x):
        ...
        x1 = F.conv2d(x1.unsqueeze(1), self.weight, padding=padding)
        x2 = F.conv2d(x2.unsqueeze(1), self.weight, padding=padding)
        x3 = F.conv2d(x3.unsqueeze(1), self.weight, padding=padding)
